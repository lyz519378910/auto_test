...
class HandExcel:
    def load_excel(self):
        ...
        open_excel = openpyxl.load_workbook('D:\\Python\\auto_test\\interface_learning\\case\\imooc.xlsx')
        return open_excel
    ...
    def excel_write_data(self,row,cols,value):
        ...
        wb.save('D:\\Python\\auto_test\\interface_learning\\util\\handle_excel.py')
